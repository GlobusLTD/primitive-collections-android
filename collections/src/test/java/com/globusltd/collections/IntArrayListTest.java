...
public class IntArrayListTest {
    ...
    public void testAddItemAt2() throws Exception {
        ...
        assertThat(intArrayList.get(2), is(200));
    }
    ...
    public void testSetItem1() throws Exception {
        ...
        assertThat(intArrayList.set(0, 300), is(100));
    }
    ...
    public void testSetItem2() throws Exception {
        ...
        intArrayList.add(100);
        intArrayList.add(200);
        intArrayList.set(0, 300);

        assertThat(intArrayList.get(0), is(300));
    }
    ...
    public void testRemoveItem() throws Exception {
        ...
        assertThat(intArrayList.removeAt(1), is(200));
    }
